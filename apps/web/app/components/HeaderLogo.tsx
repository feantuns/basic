export default function HeaderLogo() {
  return (
    <a aria-label="Home" href="/" className="text-white ">
      <figure className="w-[160px] h-[22px]">
        <svg
          color="inherit"
        ...
        >
          ...
          <path
            fill="currentColor"
            d="M204 17.2h-1.4v1.6h1.4c.5 0 .7-.3.7-.8s-.3-.8-.7-.8m-.1-.8c1.2 0 1.8.5 1.8 1.6 0 .6-.3 1.1-.9 1.3l1.2 1.8h-1.2l-1.1-1.6h-1.2v1.6h-1.1v-4.7z"
          ></path>
        </svg>
      </figure>
    </a>
